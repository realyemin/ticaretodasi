...
<div align="center">
	<div class="box">
		<div class="box-header with-border"><h2><?php echo $diller['haberResim']; ?></h2>
			<a href="index.php?islem=haberliste" class="btn btn-success"><?php echo $diller['haberList']; ?></a>
		</div>
						...
						<?php
							...
							for($k=1; $k<16; $k++)
							{
								...
								<td>
									...
									<p></p>
									<a href="index.php?islem=haberresimsil&id=<?php echo $id;?>&resimid=<?php echo $k;	?>" class="btn btn-danger btn-md"><?php echo $diller['sil']; ?></a>									
									<p>
										<?php
								...
								<td><?php if($k==1) echo "Bu Resim Manşet Resmidir"; ?>
									<form name="yukleme" method="post" action="index.php?islem=yukle&resimid=<?php echo $k; ?>&id=<?php echo $id;?>" enctype="multipart/form-data">
										<input required type="file" class="btn btn-info" name="dosya" accept="image/*"><br>
