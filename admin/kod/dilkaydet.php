...
<?php
	...
	{		
		...
		$sql = $db->prepare('INSERT INTO genel (baskanmesaj,vizyon,misyon,siteadi,baslik,altbaslik,anahtar,dil,haber,duyuru,etkinlik, link1,link2,link3,link4,link5,tabbaslik1,tabbaslik2,tabbaslik3,tabbaslik4) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)');
