<?php
	...
	*/
?>
<?php $kategoriDB=$db->query("SELECT * FROM kategori WHERE kategoriAd='".$_GET['kategori']."'")->fetch(); ?>
<?php $haberListDB=$db->query("SELECT * FROM haber WHERE dil=".$dil." AND onay=1 AND kategoriID='".$kategoriDB['id']."'", PDO::FETCH_ASSOC); ?>
	...
	<div class="container">
		<div class="trending-news separator-large">
			<div class="row">
				<div class="view-area">
					<div class="col-sm-8"> 
						<h3 class="title-bg"><?php echo $diller['kategoriList']; ?> (<?php if(isset($_GET['kategori'])){ echo $_GET['kategori']; } ?>)</h3>
					</div>
					<div class="col-sm-4 text-right">
						<a href="haberler/"><?php echo $diller['tumu'] ?> <i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
					</div>
				</div>    				
				<?php					
